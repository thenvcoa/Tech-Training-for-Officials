...
// ---------------- 1. WELCOME ----------------
{
  ...
  bodyHTML: `
    <div style="text-align:center;margin-bottom:1.4rem;">
      <img src="images/vhsl_logo.png" alt="VHSL logo" style="max-width:260px;width:100%;height:auto;">
    </div>
    <div class="card">
...
// ---------------- 2. SCORESHEET UPDATES ----------------
{
  ...
  bodyHTML: `
    ...
    <h3>Illegal Choreo vs. Illegal Execution</h3>
    <div class="card tinted">
